...
where, \textit {P$^1_{min}$} and \textit {P$^1_{max}$} are the minimum and maximum values of the peak intensity of high (`1') level. $P^1_{mean}$ and $P^0_{mean}$ are mean value of output intensity for high (`1') and low (`0') levels. Also, \textit {P$^0_{max}$} is the maximum value of intensity at low level (`0'). The $CR$ and $ER$ should be greater than 10 dB and \textit{AM}is lower than 1 dB. Also, high value of \textit{EO} determines quality of clear transmission.
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\hline\hline
\multirow{2}{*}{Optical gate}& \multirow{2}{*}{Operator}& \multirow{2}{*}{Input-Drop}& \multicolumn{2}{c|}{Intensity (a.u)}& \multirow{2}{*}{Logic} & \multirow{2}{*}{$ER$ (dB)} & \multirow{2}{*}{$CR$ (dB)} & \multirow{2}{*}{$AM$ (dB)} & \multirow{2}{*}{$EO$\%}\\
\cline{4-5}
& & &Max&Min& & & & &\\
\hline
...
Fig.\ref{fig5_adder} presents the half adder simulation results. In this case, Sum=$A'B+AB'$($A\oplus B$) and Carry=\textit {A}.\textit {B}.
   \begin{figure}[tb]
\centering
\includegraphics[width=5 in]{figs/fig5_adder.pdf}
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\hline\hline
\multirow{2}{*}{Optical gate}& \multirow{2}{*}{Operator}& \multirow{2}{*}{Input-Drop}& \multicolumn{2}{c|}{Intensity (a.u)}&\multirow{2}{*}{Logic} & \multirow{2}{*}{\textit {ER}(dB)} & \multirow{2}{*}{$CR$ (dB)} & \multirow{2}{*}{$AM$ (dB)} & \multirow{2}{*}{$EO$\%}\\
\cline{4-5}
& & &Max&Min& & & & &\\
\hline
